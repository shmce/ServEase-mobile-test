...
const styles = StyleSheet.create({
  ...
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, backgroundColor: '#fff', paddingTop: 16, paddingBottom: 34, paddingHorizontal: 16, borderTopWidth: 1, borderTopColor: '#eee' },
