  ...
  return (
    <View style={styles.addressCard}>
      ...
      <View style={styles.addressInfo}>
        <Text style={styles.addressLine1}>{address.street}, {address.barangay}</Text>
        <Text style={styles.addressLine2}>{address.city}</Text>
      </View>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {isLoading ? (
          <View style={{ marginTop: 50 }}>
            <ActivityIndicator color="#00B761" size="large" />
          </View>
        ) : addresses.length === 0 ? (
          <View style={{ alignItems: 'center', marginTop: 50 }}>
            <Ionicons name="location-outline" size={60} color="#DDD" />
            <Text style={{ color: '#999', marginTop: 10 }}>No addresses saved yet.</Text>
          </View>
        ) : (
