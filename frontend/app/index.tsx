...
export default function WelcomeScreen() {
  ...
  return (
    <View style={styles.container}><StatusBar style="light" /><Image
      ...
      /><View style={styles.content}><Image
        ...
        /><Text style={styles.tagline}>
          Finding and connecting with trusted local professionals around you.
        </Text><View style={styles.buttonContainer}><TouchableOpacity 
            style={[
              styles.signUpButton,
            ...
            activeOpacity={0.7}
          ><Text style={[styles.signUpText, isAgreed && styles.signUpTextActive]}>Sign up to ServEase</Text></TouchableOpacity><TouchableOpacity 
            style={[styles.loginButton, !isAgreed && styles.loginButtonDisabled]}
            onPress={() => handleAction('/login')}
            activeOpacity={0.7}
          ><Text style={[styles.loginText, !isAgreed && styles.loginTextDisabled]}>Log In</Text></TouchableOpacity></View><View style={styles.termsContainer}><TouchableOpacity 
            style={[styles.checkbox, isAgreed && styles.checkboxActive]} 
            onPress={() => setIsAgreed(!isAgreed)}
            activeOpacity={0.8}
          >{isAgreed && <Ionicons name="checkmark" size={14} color="#00B761" />}</TouchableOpacity><Text style={styles.termsText}>
